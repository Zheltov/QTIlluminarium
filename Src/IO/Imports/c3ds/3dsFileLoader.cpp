//// cout// 3dsFileLoader.cpp: implementation of the C3dsFileLoader class.
//
//////////////////////////////////////////////////////////////////////
...
void C3dsFileLoader::ReadViewPortData()
{
	...
	if (!ReadBlock((char *) camera_name, CameraNameSize))
		return;
//	UserViewPortData(ViewPortData(flags, axis_lockout, win_x, win_y, win_w, win_h, win_view, zoom, worldcenter_x, worldcenter_y, worldcenter_z, horiz_ang, vert_ang, camera_name));
}
